...
print('get_course_filename_str version: {}'.format('1.3'))
def get_course_filename_str(title: str, caption='XX',
             sect='XX', ftype = 'PNG',
...
print('save_course_table_csv version: {}'.format('1.3'))
def save_course_table_csv(data, title: str, caption="XX", 
              sect='XX',course='D209', 
...
print('create_barplot_num_vs_cat_fig version: {}'.format('1.8'))
def create_barplot_num_vs_cat_fig(data, num_target, cat_feature,
        title='',caption='',course='WGU course',task='Task1'):
    """
...
print('create_distribution_plot_from_feature_fig version: {}'.format('1.8'))
def create_distribution_plot_from_feature_fig(
    data, cat_or_bool_feature, title='',
    caption='', course='', sect='', task='Task1'):
    """
...
print('get_top_n_correlations version: {}'.format('1.0'))
def get_top_n_correlations(df, n=5):
...
print('create_simple_histogram_numerical_feature_fig version: {}'.format('1.8'))
def create_simple_histogram_numerical_feature_fig(
    ...
    f=get_course_filename_str(title=title, caption=caption,
                  course=course, task='Task1', sect=sect,
                  ftype='PNG', subfolder='figures')
    plt.gcf().text(0, -.05, f, fontsize=14)
    fig.savefig(f, dpi=150, bbox_inches='tight') 
    print('Figure saved to: {}'.format(f)) # feedback to notebook
...
print('create_stacked_barplot_cat_or_bool_feature_fig version: {}'.format('1.6'))
def create_stacked_barplot_cat_or_bool_feature_fig(
    data, cat_or_bool_feature, target,
    title='', caption='', course='', sect='',
    task='Task1', bins=9, isCat=True):
...
print('create_stacked_histogram_num_feature_fig version: {}'.format('1.5'))
